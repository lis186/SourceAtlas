...
| 任務 | 以前 | 現在 |
|------|------|------|
| 理解專案架構 | 2-3 天 | **5-15 分鐘** |
| 找 API 實作範例 | 問同事 / 亂翻 | **0.1-30 秒** |
...
在 **5 個真實開源專案**測試：Firefox iOS、Discourse、Cal.com、Prefect、Thunderbird
...
| 命令 | 解決的問題 | 時間 |
|------|-----------|------|
| `/atlas.overview` | 新接手專案，需要全貌 | 5-15 分鐘 |
| `/atlas.pattern "X"` | 需要實作 X，想找範例 | 0.1-30 秒 |
