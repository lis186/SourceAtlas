...
> 🌐 [English](./USAGE_GUIDE.md) | **繁體中文**

**7 個斜線命令的完整使用說明**

適用於 Claude Code | v2.9.0 | Constitution v1.1
...
9. [命令 6: /atlas.deps](#命令-6-atlasdeps) ⭐ NEW
10. [命令 7: /atlas.init](#命令-7-atlasinit)
11. [常見問題](#常見問題)
...
**預期結果**：
- ✅ 看到 7 個 .md 檔案（init, overview, pattern, impact, history, flow, deps）
- ✅ 看到 scripts/atlas/ 目錄
- ✅ 在專案根目錄（有 .git/）
