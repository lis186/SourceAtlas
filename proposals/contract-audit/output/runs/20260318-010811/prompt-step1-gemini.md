...
## Refactoring Intent
重構 God Object WhisperState：拆分錄音狀態、模型管理、後處理鏈三個職責
...
- /Users/justinlee/src/tries/2026-02-21-voiceink/VoiceInk/VoiceInk/Whisper/LibWhisper.swift
- /Users/justinlee/src/tries/2026-02-21-voiceink/VoiceInk/VoiceInk/Whisper/WhisperPrompt.swift
- /Users/justinlee/src/tries/2026-02-21-voiceink/VoiceInk/VoiceInk/Whisper/WhisperState+ModelManagement.swift
- /Users/justinlee/src/tries/2026-02-21-voiceink/VoiceInk/VoiceInk/Whisper/WhisperState+UI.swift
import Foundation
import SwiftUI
import AVFoundation
import SwiftData
    ...
    private func transcribeAudio(on transcription: Transcription) async {
        ...
        do {
            ...
            if UserDefaults.standard.string(forKey: "SelectedLanguage") == "zh-TW" {
                text = ChineseConverter.simplifiedToTraditional(text)
            }
