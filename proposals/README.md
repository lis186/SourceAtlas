...
- **[atlas.audit — 行為合約審計](./contract-audit/README.md)**
  - **目標**: 多 LLM 交叉驗證提取遺留代碼隱含合約，產出可機器驗證的 CI 斷言
  - **來源**: `nineyiappshop/audit/` 已驗證原型（49 合約、4 bug 發現）
  - **核心工作**: Prompt 拆分為骨架+語言插件、配置檔驅動管線、第二語言驗證
  - **適用場景**: 核心模組語言遷移、高風險模組重構
